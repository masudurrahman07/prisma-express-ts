...
**Frontend:** https://shoply-three-blush.vercel.app/

**Backend API:** https://shoply-backend-epto.onrender.com/
...
Or build and start the production bundle:
...
Complete API documentation with request bodies, parameters, and status codes can be found in:
...
**GitHub:** https://github.com/masudurrahman07/prisma-express-ts

**Live Frontend:** https://shoply-three-blush.vercel.app/

**Live Backend:** https://shoply-backend-epto.onrender.com/
